    ...
    return (
        <div className='mt-28 mb-20'>
            <div className='border-[1px] border-slate-400 p-5 md:p-10 w-[100%] md:w-[80%] h-[600px] overflow-x-auto mx-auto text-black'>
                ...
                <hr />
                <div className='mt-4'>
                    <p className="text-sm md:text-md">Email: <span className='underline'>yeasinbinali@gmail.com</span> | Mobile: (+880) 1305256024</p>
                    <p className="text-sm md:text-md">Address: Dhaka, Bangladesh</p>
                    <div>
                ...
                <ul className='mt-4 ml-8'>
                    <li className='text-sm md:text-md mb-2 md:mb-0' style={{ listStyle: 'inside' }}>Proficient: JavaScript, ReactJS, HTML, CSS, Bootstrap, Tailwind, Flowbite</li>
                    <li className='text-sm md:text-md mb-2 md:mb-0' style={{ listStyle: 'inside' }}>Familiar: Material UI, Firebase (Auth, Storage, FirestoreDB), NodeJS, MongoDB, ExpressJS, Stripe Payment</li>
                    <li className='text-sm md:text-md mb-2 md:mb-0' style={{ listStyle: 'inside' }}>Tools: Git, VS Code, Chrome Dev Tools, Netlify, Vercel, Figma, NPM</li>
                    <li className='text-sm md:text-md' style={{ listStyle: 'inside' }}>Soft skills: Adaptability, Detail-oriented, Quick learner, Teamwork</li>
                </ul>
                ...
                <div className='mt-4'>
                    ...
                    <p className="text-sm md:text-md">Tech used: Flowbite, React Router Dom, ReactJS, Firebase auth, NodeJS, MongoDB,
                ...
                <div className='mt-4'>
                    ...
                    <p className="text-sm md:text-md">Tech used: DaisyUI, React Router Dom, ReactJS, Firebaes auth, NodeJS, MongoDB,
                ...
                <div className='mt-4'>
                    ...
                    <p className="text-sm md:text-md">Tech used: DaisyUI, React Router Dom, ReactJS, Firebase auth, NodeJS, MongoDB,
                        ExpressJS, Stripe payment</p>
                </div>

                <h2 className='text-lg md:text-xl mt-4'>Education</h2><hr />
                <p className='mt-4 font-bold text-sm md:text-md'>University of Dhaka</p>
                <p className="text-sm md:text-md">September 2022 to Present | BBA in Management Information Systems (MIS)</p>

                <h2 className='text-lg md:text-xl mt-4'>Language</h2><hr />
                <p className='mt-4 text-sm md:text-md'>English (comfortable), Bengali (Native), Hindi (listen & speak)</p>
            </div>
            <div className='mt-10'>
